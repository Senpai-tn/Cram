...
correspondant as c 
where c.code = fc.code and FC.num = '$num'");
      $stmt->execute();
...
<div id="code_ville" style="text-align: right; margin-right: 100px;">'.$row['code_postal'].'</div>
</p>
...
file_put_contents( $path,  $dompdf->output() );
        ...
        $mail->Subject = 'Remerciement N :'.$row['num_facture'];                     //Sets the Subject of the message
