...
{
  var departement = parseInt($('input[name=code_postal]').val().substring(0,2));
	...
	$(".hide2").fadeOut();
	  ...
	  // add
	   function add_info(){
        ...
        setInterval(function(){if(i==0){ select_prestataire_by_group('c');
        select_group_by_code();i=1; }}, 1000);
	   		$('#modal2').modal('show');
	   }
