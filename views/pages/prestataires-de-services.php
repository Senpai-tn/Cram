...
function Confirm_Update()
  {
	...
	var new_street_number = $('#new_street_number').val();
...
{
				  $('input[name=get_data_num_serie').val('');
                  $('input[name=new_num_serie]').val('');
                  $('input[name=new_raison_sociale]').val('');
                  $('input[name=new_adresse]').val('');
                  $('input[name=new_code_postal]').val('');
                  $('input[name=new_abonnement]').val('');
                  $('input[name=new_telephone]').val('');
                  //$('select[name=new_type_facture]').val(data['success']['type_facture']);
                  $('input[name=new_honoraire]').val('');
                  $('select[name=new_etat]').val('');
                  $('textarea[name=new_commentaire]').val('');
                  $('select[name=select_new_moyen]').val('');
				  $('#new_street_number').val('');
				  $('input[name=new_ville]').val('');
				  $('#autocomplete2').val('');
   $.ajax({
        data: 
        { 
          ...
          if(data['success'] != null)
                {
				  ...
				  $('#new_street_number').val(data['success']['street_number']);
				  $('input[name=new_ville]').val(data['success']['ville']);
             }     
        }
      });
}
...
{
  var dep =                   '<option value="01">01 - Ain</option>'+
                              '<option value="02">02 - Aisne</option>'+
                              '<option value="03">03 - Allier</option>'+
                              '<option value="04">04 - Alpes-de-Haute-Provence</option>'+
                              '<option value="05">05 - Hautes-Alpes</option>'+
  ...
  $.ajax({
        ...
        success: function(data){
          ...
          {            
			...
			$('input[name=raison_sociale]').val('');
			$('input[name=adresse]').val('');
			$('input[name=code_postal]').val('');
			$('input[name=abonnement]').val('');
			$('input[name=telephone]').val('');
			$('select[name=type_facture]').val('');
			$('input[name=honoraire]').val('');
			$('textarea[name=commentaire]').val('');
			$('input[name=ville]').val('');
			$('#street_number').val('');
			$('#autocomplete_google').val('');
            $('#modal1').modal('hide');
            swal("Success","Modification est terminée avec success","success");
          }
          else{
