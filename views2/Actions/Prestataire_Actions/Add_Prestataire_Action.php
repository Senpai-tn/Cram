...
include "../../../Controllers/ConnectionController.php";
	...
	{	
	 	...
	 	$sql = "insert into prestataire (`num_serie`, `raison_sociale`, `adresse`, `code_postal`, `abonnement`, `telephone`, `etat`, `commentaire`,  `code_moyen`, `honoraire`, `nbr_signalement_payee`,ville)
        VALUES (
                '$num_serie',
                '$raison_sociale',
                '$adresse',
        ...
        { 
            $sql = "insert INTO `departement` (`num_serie`, `departement`) VALUES ( '$num_serie', '".$listD[$i]."');
            )";
