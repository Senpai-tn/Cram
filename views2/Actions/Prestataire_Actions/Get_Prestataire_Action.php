<?php
	...
	try{
	    ...
	    {
	    	$prestataire = new Prestataire($row['num_serie'],$row['raison_sociale'],$row['adresse'],$row['code_postal'],$row['abonnement'],$row['telephone'],$row['etat'],$row['commentaire'],$row['code_moyen'],$row['honoraire'],$row['dep'],$row['ville']);
