			               ...
			               <div class="row">
					                <div class="col-md-12">
										<div class="form-group">
					                      ...
					                      <div class="position-relative has-icon-left">
											<input type="text" id='autocomplete' class="form-control " placeholder="Adresse" name="adresse0" autocomplete="0">
                    ...
                    <div class="form-group">
                          ...
                          <div class="position-relative has-icon-left">
							...
							<div class="form-actions right">
				                ...
				                <button type="button" id="add-user" onclick="add_info();select_prestataire();select_correspondant();select_prestataire_by_group('c')" class="btn btn-primary">
...
function select_prestataire_by_group(code)
{
  if(code=="")
    ...
    var code_postal = parseInt($('input[name=code_postal]').val().substring(0,2));
  $.ajax({
        type:"POST",
...
{
  var departement = $('input[name=code_postal]').val();
  $.ajax({
        type:"POST",
